...
import { Pen, Eye, Eraser, Save, Download, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="bg-white border-b border-gray-200 px-4 py-2 flex items-center justify-between shadow-sm sticky top-0 z-50 overflow-x-auto no-scrollbar">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        {/* Actions Group */}
        <div className="flex items-center gap-1 border-l pl-2 sm:pl-4 border-gray-200">
            {/* Save Button */}
            <button 
                onClick={onSave}
                ...
                title="Salvar como Nota (.note) editável"
            >
            ...
            <button 
                ...
                className="flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium text-slate-600 hover:bg-slate-100 transition-colors disabled:opacity-50"
                title="Exportar como PDF Final"
            >
